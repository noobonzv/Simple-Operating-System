...
; showinf:						;会很卡
    ...
    ; mov bx,0ACh ;bl 6-4背景色  3位1前景色高亮  2-0 前景色RGB
    ; mov dh,6	;行
	; mov dl,6    ;列
    ; int 10h
LABEL_SHOW_ID:	
	mov ah,8Dh	;属性
	mov al,'1'
	mov word[gs:((80 * 7 + 15) * 2)], ax
	mov al,'7'
	mov word[gs:((80 * 7 + 16) * 2)], ax
	mov al,'3'
	mov word[gs:((80 * 7 + 17) * 2)], ax
	mov al,'4'
	mov word[gs:((80 * 7 + 18) * 2)], ax
	mov al,'1'
	mov word[gs:((80 * 7 + 19) * 2)], ax
	mov al,'1'
	mov word[gs:((80 * 7 + 20) * 2)], ax
	mov al,'8'
	mov word[gs:((80 * 7 + 21) * 2)], ax
	mov al,'9'
	mov word[gs:((80 * 7 + 22) * 2)], ax
