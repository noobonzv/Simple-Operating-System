...
LABEL_SHOW4:	
	mov ah,8Dh
	mov al,'Y'
	mov word[gs:((80 * 19 + 56) * 2)], ax
	mov al,'a'
	mov word[gs:((80 * 19 + 57) * 2)], ax
	mov al,'o'
	mov word[gs:((80 * 19 + 58) * 2)], ax
	mov al,'S'
	mov word[gs:((80 * 19 + 59) * 2)], ax
	mov al,'e'
	mov word[gs:((80 * 19 + 60) * 2)], ax
	mov al,'n'
	mov word[gs:((80 * 19 + 61) * 2)], ax
	mov al,'J'
	mov word[gs:((80 * 19 + 62) * 2)], ax
